<div>
        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 md:px-12">
            ...
            <div class="md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
                ...
                <p class="text-lg md:text-xl text-gray-200 mb-8">
                    Wadah perjuangan mahasiswa Islam dalam mewujudkan insan akademis, pencipta, pengabdi yang
                    bernafaskan Islam.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                    ...
                    <!-- Gambar tambahan untuk mobile (muncul tepat setelah h2) -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @foreach ($programKerjaAktif as $program)
                        <div class="bg-linear-to-br from-green-50 to-green-100 p-6 rounded-lg border border-green-200">
                            <span
                                class="inline-block px-3 py-1 text-xs font-semibold bg-green-500 text-white rounded-full mb-4">Aktif</span>
    ...
    <!-- CTA Section -->
    <div
        class="reveal bg-linear-to-r  from-emerald-400 to-green-600 text-white py-16 opacity-0 translate-y-10 transition-all duration-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('tentang') }}" wire:navigate
                class="inline-block bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-indigo-50 transition">
