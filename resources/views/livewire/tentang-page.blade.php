        ...
        @if ($sejarahKepengurusan->count() > 0)
            <div class="reveal bg-white p-6 rounded-xl shadow opacity-0 translate-y-10 transition-all duration-700">
                ...
                @php
                    ...
                    $total = $sejarahKepengurusan->count();
                    $lgColumns = 3;
                    $mdColumns = 2;
                    ...
                    $lgChunks = $sejarahKepengurusan->chunk($itemsPerLgColumn);
                    $mdChunks = $sejarahKepengurusan->chunk($itemsPerMdColumn);
                @endphp
                        ...
                        <div class="space-y-8">
                            @foreach ($chunk as $periode)
                                <div class="flex">
                                    ...
                                    <div>
                                        <span
                                            class="bg-green-100 text-green-800 text-sm font-semibold px-3 py-1 rounded-full">{{ $periode->periode_mulai }}
                                            - {{ $periode->periode_berakhir }}</span>
                        ...
                        <div class="relative mb-10">
                            ...
                            <div class="ml-8 pt-3">
                                ...
                                <div class="mt-3 text-base text-slate-600">
                                    <p><span class="font-semibold text-slate-700">Ketua Umum:</span> {{ $periode->ketua }}
                                    </p>
                                    @if (!empty($periode['wakil_ketua']))
                                        <p><span class="font-semibold text-slate-700">Wakil Ketua:</span>
                                            {{ $periode->wakil_ketua }}</p>
